...
RUN rm /ardupilot/Tools/autotest/pysim/vehicleinfo.py
COPY ./modified_files/vehicleinfo.py /ardupilot/Tools/autotest/pysim/
COPY ./modified_files/gazebo-drone* /ardupilot/Tools/autotest/default_params/
